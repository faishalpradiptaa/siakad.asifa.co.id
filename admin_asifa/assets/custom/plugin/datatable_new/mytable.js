$.fn.myTable = function(options) 
{
	...
	var format_number = {
		body: function ( data, row, column, node ) {
			return $("thead tr th:nth("+column+")", container).hasClass('export-number') ? data.replace( /[,.]/g, '' ) : data;
		}
	}
	var settings = $.extend({
		buttons: [
			...
			{extend: "excelHtml5", text: "<i class='glyphicon glyphicon-floppy-save'></i>&nbsp; Excel", exportOptions: { columns: ':visible', format:format_number}}, 
