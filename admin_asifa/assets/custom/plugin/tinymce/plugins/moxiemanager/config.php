<?php
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = '../../../../../../../assets/upload';
	...
	$moxieManagerConfig['SessionAuthenticator.logged_in_key'] = 'hasasu';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "hasasu", "password" => "23asd832ueadh37yeyausd6", "groups" => array("administrator"))
	);
