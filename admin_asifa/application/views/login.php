...
<head>
	<meta charset="utf-8"/>
	<title>ASIFA | Login Administrator</title>
...
<body class="login">
	...
	<div class="content">
		...
		<form class="login-form" action="<?php echo base_url(); ?>" method="post">
			...
			<div class="form-group">
				...
				<input class="form-control form-control-solid placeholder-no-fix" value="<?php echo $username; ?>" type="text" autocomplete="off" placeholder="Username" name="user_username" required/>
			</div>
			<div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">Password</label>
				<input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="user_password" required/>
			</div>
			...
			<div class="create-account">
				<p>
					<a href="javascript:;" class="uppercase">SIAKAD ASIFA</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->
    ...
    <script src="<?php echo base_url()?>assets/plugins/fingerprint/fingerprint.js" type="text/javascript"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
