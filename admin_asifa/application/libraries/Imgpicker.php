...
class Imgpicker
{
	...
	{
		if (!isset($this->options['load'])) return;
	...
	{
		if (!isset($this->options['delete'])) return;
	...
	public function resizeImage($src_path, $dst_path = null, $src_x, $src_y, $dst_w, $dst_h, $src_w, $src_h)
	{
	    ...
	    if (isset($src_image) && !$src_image) return false;
